...
document.addEventListener("DOMContentLoaded", () => {
    const navLinksSticky = document.querySelectorAll('.nav-link');
    const sectionsSticky = document.querySelectorAll('section');
...
ScrollReveal().reveal('.home-img img, .services-container, .portfolio-box, .testimonial-wrapper, .contact from', { orgin: 'bottom' });
